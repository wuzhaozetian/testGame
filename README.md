...
### gameConfig.json
All game parameters with standard format:
```json
{
  "configGroup": {
    "parameterName": {
...
```json
{
  "assetPack": {
    "files": [
      ...
      { "type": "image", "key": "player_idle_01", "url": "assets/player_idle_01.png" },
      { "type": "image", "key": "player_run_01", "url": "assets/player_run_01.png" },
      { "type": "image", "key": "player_run_02", "url": "assets/player_run_02.png" },
      { "type": "tilemapTiledJSON", "key": "level1_map", "url": "assets/level1_map.json" }
    ]
  }
}
```
