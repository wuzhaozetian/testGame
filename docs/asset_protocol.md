...
- **Call 2*: Remaining animations + audio
...
```json
{
  "assetPack": {
    "files": [
      { "type": "animation", "key": "animations", "url": "assets/animations.json" }
    ]
  },
  "backgrounds": {
    "files": [
  ...
  "hero_frames": {
    "files": [
      { "type": "image", "key": "hero_idle_01", "url": "assets/hero_idle_01.png" },
      { "type": "image", "key": "hero_idle_02", "url": "assets/hero_idle_02.png" }
    ]
  },
  "audio": {
    "files": [
