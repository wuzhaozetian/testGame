...
cp -r /workspace/projects/GameCursor/agent-test/templates/core/* ./

# Step 2: Copy module-specific code INTO src/ (ADDITIVE merge)
cp -r /workspace/projects/GameCursor/agent-test/templates/modules/{archetype}/src/* ./src/

# Step 3: Copy core documentation
mkdir -p docs/gdd
cp /workspace/projects/GameCursor/agent-test/docs/gdd/core.md docs/gdd/
cp /workspace/projects/GameCursor/agent-test/docs/asset_protocol.md /workspace/projects/GameCursor/agent-test/docs/debug_protocol.md docs/

# Step 4: Copy module-specific documentation
mkdir -p docs/modules/{archetype}
cp -r /workspace/projects/GameCursor/agent-test/docs/modules/{archetype}/* docs/modules/{archetype}/
```
...
- `/workspace/projects/GameCursor/agent-test/docs/gdd/core.md` — universal GDD format
- `/workspace/projects/GameCursor/agent-test/docs/modules/{archetype}/design_rules.md` — game design guide (gameplay, flow, feel)
- `/workspace/projects/GameCursor/agent-test/docs/modules/{archetype}/template_api.md` — code capability list (systems, hooks, components)
